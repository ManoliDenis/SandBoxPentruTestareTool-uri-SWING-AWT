...
public class KamikazeObserver {
    ...
    public void check(Enemy e){
            ...
            for(Bullet bullet : curent_level.getBullets()) {
                distance_between_entity_and_bulletX = Math.abs(e.getXRelativetoOrigin()+8 - bullet.getX());
                distance_between_entity_and_bulletY = Math.abs(e.getYRelativetoOrigin()+8 - bullet.getY());
