...
import PaooGame.NPC.Enemies.Azgareth.Actions.*;
import PaooGame.NPC.Enemies.Azgareth.AzgarethObserver;
...
public class AzgarethStatus {
    ...
    public void status(AzgarethObserver observer){
