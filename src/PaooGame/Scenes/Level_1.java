...
import PaooGame.NPC.Enemies.SlimeKing.SlimeKing;
...
public class Level_1 implements Level_Template {
    //////////////////////////////////////////////////////////////////////
   ...
   public static final Color[] INTERACTIBLES = {Color.WHITE, Color.BLACK};
    ...
    public static final int[][] map = new int[57][46];
    ...
    public  void spawnBullet(double startX, double startY, double targetX, double targetY) {
        ...
        if(GameVariables.DEBUG)
            System.out.println( "coord player: " + playerGlobalX + " " + playerGlobalY);
    }
    ...
    public void levelInit() {
        ...
        /////////////////////////////////////////////////MAP LOGIC///////////////////////////////////////////////////////////////////
        readMap("src/PaooGame/Scenes/Level1.txt");
        /////////////////////////////////////////////////MAP LOGIC END///////////////////////////////////////////////////////////////
        if(GameVariables.LOADED) {
            ...
            mapPositionX = -1300;
            mapPositionY = -2200;
            sceneManager.setOffsets(mapPositionX, mapPositionY);
        ...
        GameVariables.playerATKDAMAGE = 10;
            ...
            entity = rascal_spawner.SpawnEnemy(1800,2600,mapPositionX,mapPositionY);///1600,2600);///Entity e inamicul care devine rascal (1600,2600)
            manager = new EnemyManager();///1800 2600
            manager.add(entity);
            manager.add(new SlimeKingSpawner().SpawnEnemy(800,1800,mapPositionX,mapPositionY));
            manager.add(new RascalSpawner().SpawnEnemy(1800,1800,mapPositionX,mapPositionY));
            manager.add(new RascalSpawner().SpawnEnemy(1800,1400,mapPositionX,mapPositionY));
            manager.add(new RascalSpawner().SpawnEnemy(1800,700,mapPositionX,mapPositionY));
            manager.add(new RascalSpawner().SpawnEnemy(2800,1400,mapPositionX,mapPositionY));
            //manager.add(new RascalSpawner().SpawnEnemy(2800,2000,mapPositionX,mapPositionY));
            manager.add(new KamikazeSpawner().SpawnEnemy(2800,1400,mapPositionX,mapPositionY));
    ...
    public void levelUpdate(GameWindow wnd) {
        ...
        if(!pauseState) {
           if (PlayerInput.isEscPressed()) {
            ...
            { GameVariables.continuedlevel = true;
                sceneManager.levelLoader(sceneManager.levels.Level_2);
                return;
            }
        ...
        while (it.hasNext()) {
            Bullet b = it.next();
            // acum cu harta si offset-urile poziției camerei
            if (!b.update(sceneManager.getPosX(), sceneManager.getPosY(), map)) {
                it.remove();   // proiectil distrus la impact cu wall
            }
        }
    ...
    public void levelDraw(Graphics g, GameWindow wnd) {
        ...
        for (Bullet b : bullets) {
            b.draw(g, mapPositionX, mapPositionY);
        }
        //Death Screen
        ...
        if(!saveMenu) {
            ...
            if (PlayerInput.isEnterPressed()) {  /// Pentru selectia optiunii
                switch (INTERACTIBLES_INDEX) {  /// Daca e selectata
                    ...
                    case 1 ->{if(saveLock) {System.out.println("Saved");GameVariables.SAVE_MODULE.Save(saveIndex,GameVariables.PLAYER_NAME,mapPositionX,mapPositionY,1,GameVariables.HP,GameVariables.SCORE);saveLock=false;}}/// Load
