...
import PaooGame.NPC.Enemies.Ceye.Ceye;
...
import static PaooGame.SceneManager.sceneManager.*;

public class Level_2 implements Level_Template {
    //////////////////////////////////////////////////////////////////////
    /// DATA & VARIABLES START/////////////////////////////////////////////

    public static final Color[] INTERACTIBLES = {Color.WHITE, Color.BLACK};

    public static final int[][] map = new int[22][47];
    ...
    public void levelInit() {
        ...
        /////////////////////////////////////////////////MAP LOGIC///////////////////////////////////////////////////////////////////
        readMap("src/PaooGame/Scenes/Level2.txt");
        /////////////////////////////////////////////////MAP LOGIC END///////////////////////////////////////////////////////////////
        ...
        manager.add(new CeyeSpawner().SpawnEnemy(450,700,mapPositionX,mapPositionY));
        manager.add(new CeyeSpawner().SpawnEnemy(450,1300,mapPositionX,mapPositionY));
        manager.add(new CeyeSpawner().SpawnEnemy(450,1800,mapPositionX,mapPositionY));
        manager.add(new RascalSpawner().SpawnEnemy(250,700,mapPositionX,mapPositionY));
        manager.add(new RascalSpawner().SpawnEnemy(250,1300,mapPositionX,mapPositionY));
        manager.add(new RascalSpawner().SpawnEnemy(250,1800,mapPositionX,mapPositionY));
        manager.add(new AzgarethSpawner().SpawnEnemy(250,2500,mapPositionX,mapPositionY));
        //////////////////////////ENEMY LOGIC END////////////////////////////
    ...
    public void levelUpdate(GameWindow wnd) {
        ...
        if(!pauseState) {
            ...
            { GameVariables.continuedlevel = true;
                sceneManager.levelLoader(sceneManager.levels.Level_3);return;}

            WCTD.think();
            manager.update(mapPositionX,mapPositionY);
            NextLevelDoor.nextLevelDoor(2);
        }/////////////////////////////////////////////////GAMEPLAY END///////////////////////////////////////////////////////////////////
    ...
    public void levelDraw(Graphics g, GameWindow wnd) {
        if(!pauseState) {
            ...
            /// Tiles pentru map
            this.setMapTile(10, 23, 15); //Patch
            this.setMapTile(11, 23, 15); //Patch
        ...
        if(!saveMenu) {
            ...
            if (PlayerInput.isEnterPressed()) {  /// Pentru selectia optiunii
                switch (INTERACTIBLES_INDEX) {  /// Daca e selectata
                    ...
                    case 1 ->{if(saveLock) {System.out.println("Saved");GameVariables.SAVE_MODULE.Save(saveIndex,GameVariables.PLAYER_NAME,mapPositionX,mapPositionY,2,GameVariables.HP,GameVariables.SCORE);saveLock=false;}}/// Load
